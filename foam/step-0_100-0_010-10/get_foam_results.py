...
def get_normalized_maps(iteration = 0):
    ...
    #model = [(0,1.3,1,2),(0,0.7,1,1.3),(0,0,1,0.7),(1,1.3,2,2),(1,0,2,0.7),(2,1.3,10,2),(2,0.7,10,1.3),(2,0,10,0.7)] # discribes, how the model is build, every block is a tupel
    #model = [(0,1,1,2),(0,0,1,1),(1,1,4.5,2),(1,0,4.5,1),(4.5,1,5.5,2),(4.5,0,5.5,1),(5.5,1,9,2),(5.5,0,9,1),(9,1,10,2),(9,0,10,1)] # model: empty
    model = [(0,0,1,1),(1,1,4.5,2),(1,0,4.5,1),(4.5,1,5.5,2),(4.5,0,5.5,1),(5.5,1,9,2),(5.5,0,9,1),(9,1,10,2),(9,0,10,1)] # model: step
    #model = [(0,0,1,1),(1,1,4.5,2),(1,0,4.5,1),(4.5,1,5.5,2),(4.5,0,5.5,1),(5.5,1,9,2),(5.5,0,9,1),(9,1,10,2)] # model: curve
    #model = [(0,0,1,1),(1,1,4.5,2),(1,0,4.5,1),(4.5,1,5.5,2),(4.5,0,5.5,1),(5.5,1,9,2),(5.5,0,9,1),(9,0,10,1)] # model: expand
    #model = [(0,0,1,1),(1,1,4.5,2),(1,0,4.5,1),(4.5,1,5.5,2),(5.5,1,9,2),(5.5,0,9,1),(9,0,10,1)] # model: slalom_alt
    #model = [(0,0,1,1),(1,1,4.5,2),(1,0,4.5,1),(4.5,1,5.5,2),(5.5,1,9,2),(5.5,0,9,1),(9,1,10,2),(9,0,10,1)] # model: slalom_neu
    scale = 10
